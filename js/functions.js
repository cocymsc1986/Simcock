$(document).ready(function() {	
	...
	window.addEventListener(orientationEvent, function() {
	    if(window.orientation == 0)
	    {
	      ...
	      document.getElementById('navShowHide').style.display = '';
	      document.getElementById('showHide').style.display = '';
	      document.getElementById('mobileNavigationLandscape').style.display = 'none';
	      document.getElementById('navShowHideLandscape').style.display = 'none';
	      document.getElementById('showHideLandscape').style.display = 'none';
	    }
	    else if(window.orientation == 90 || window.orientation == -90 )
	    {
	      document.getElementById('mobileNavigation').style.display = 'none';
	      document.getElementById('navShowHide').style.display = 'none';
	      document.getElementById('showHide').style.display = 'none';
	      document.getElementById('mobileNavigationLandscape').style.display = 'block';
	      /*document.getElementById('navShowHideLandscape').style.display = 'block';
	      document.getElementById('showHideLandscape').style.display = 'block';*/
